...
local data = {
	...
	orc = {deDE={"Orc", "Orcin"},enUS={"Orc"},esES={"Orco"},esMX={"Orco","Orco"},frFR={"Orc","Orque"},itIT={"Orco","Orchessa"},koKR={"오크","오크"},ptBR={"Orc","Orquisa"},ptPT={"Orc","Orquisa"},ruRU={"Орк","Орчиха"},zhCN={"兽人","兽人"},zhTW={"獸人","獸人"}},
	...
	tauren = {deDE={"Tauren", "TaurenFrau"},enUS={"Tauren"},esES={"Tauren"},esMX={"Tauren","Tauren"},frFR={"Tauren","Taurène"},itIT={"Tauren","Tauren"},koKR={"타우렌","타우렌"},ptBR={"Tauren","Taurena"},ptPT={"Tauren","Taurena"},ruRU={"Таурен","Тауренка"},zhCN={"牛头人","牛头人"},zhTW={"牛頭人","牛頭人"}},
	gnome = {deDE={"Gnom", "Gnomin"},enUS={"Gnome"},esES={"Gnomo","Gnoma"},esMX={"Gnomo","Gnoma"},frFR={"Gnome","Gnome"},itIT={"Gnomo","Gnoma"},koKR={"노움","노움"},ptBR={"Gnomo","Gnomida"},ptPT={"Gnomo","Gnomida"},ruRU={"Гном","Гномка"},zhCN={"侏儒","侏儒"},zhTW={"地精","地精"}},
	troll = {deDE={"Troll", "Trollfrau"},enUS={"Troll"},esES={"Trol"},esMX={"Trol","Trol"},frFR={"Troll","Trollesse"},itIT={"Troll","Troll"},koKR={"트롤","트롤"},ptBR={"Troll","Trolesa"},ptPT={"Troll","Trolesa"},ruRU={"Тролль"},zhCN={"巨魔","巨魔"},zhTW={"食人妖","食人妖"}},
